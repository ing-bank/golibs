...
const (
	BestCompression    CompressionMode = gzip.BestCompression
	BestSpeed          CompressionMode = gzip.BestSpeed
	DefaultCompression CompressionMode = gzip.DefaultCompression
	NoCompression      CompressionMode = gzip.NoCompression
	HuffmanOnly        CompressionMode = gzip.HuffmanOnly
)
...
func Middleware(cfg *Config) gin.HandlerFunc {
	...
	return Gzip(int(cfg.CompressionMode))
}
